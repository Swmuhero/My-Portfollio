...
export function Footer() {
  return (
    <footer
      id="footer"
      className="relative overflow-hidden border-t border-white/5 bg-background px-6 pt-24 md:px-10 md:pt-32"
    >
      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        <div className="flex flex-col gap-2 border-t border-white/8 py-5 font-mono text-[10px] uppercase tracking-[0.24em] text-zinc-500 md:flex-row md:items-center md:justify-between">
